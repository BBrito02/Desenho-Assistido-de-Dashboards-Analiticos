...
\section{Home Page}
\label{sec:cap4_home_page}

AQUI VER SE É MESMO NECESSÁRIO CRIAR UM SECÇÃO PARA APRESENTAR A HOME PAGE

\section{Modo de Edição}
\label{sec:cap4_editor_mode}

\subsection{Ambiente de Edição e Canvas (AQUI O TEXTO DIZ QUE A IMAGEM APRESENTA O ESTADO INICIAL DA APLICAÇÃO, TENHO DE ALTERAR // ALTERAR TAMBÉM ONDE DESCREVO OS BOTÕES DO CABEÇALHO DO CANVAS)}
