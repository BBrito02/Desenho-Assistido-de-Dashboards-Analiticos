...
\section{Arquitetura do Sistema (DAR MAIS DETALHE NO JSON E A SUA ESTRUTURA)}
...
\subsection{Edição de Propriedades e Estrutura Semântica (Perguntar se aqui adiciono em anexo todos os popups que eu menciono nos bullet points)}
