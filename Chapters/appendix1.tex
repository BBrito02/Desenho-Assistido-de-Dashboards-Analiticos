...
\chapter{Resultados Questionário}
\label{app:resultados_questionario}

\begin{figure}[htbp]
  \includegraphics[width=\textwidth]{SUSrespostas}
  \centering
  \caption{Resultados do questionário SUS (System Usability Scale).}
  \label{fig:sus_respostas}
\end{figure}

\begin{figure}[htbp]
  \includegraphics[width=\textwidth]{TLXrespostas}
  \centering
  \caption{Resultados do questionário NASA-TLX.}
  \label{fig:tlx_respostas}
\end{figure}